      ...
      <div className="relative aspect-[4/3] bg-gray-900 sm:aspect-[21/7.6] sm:min-h-[385px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-10">
          ...
          >
            ...
            <h2 className="mb-2 line-clamp-3 max-w-3xl break-words font-[family-name:var(--font-gaming)] text-sm font-bold leading-tight text-white sm:text-xl md:text-2xl lg:text-3xl">
              {article.title}
            </h2>
            {article.summary && (
